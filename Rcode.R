...
# Preictal training and testing data segments are provided covering one hour
# prior to seizure with a five minute seizure horizon. 
# (i.e. from 1:05 to 0:05 before seizure onset.) 
# This pre-seizure horizon ensures that 1) seizures could be predicted with 
# enough warning to allow administration of fast-acting medications, and 2) 
#any seizure activity before the annotated onset that may have been 
#missed by the epileptologist will not affect the outcome of the competition.
library(R.matlab)
